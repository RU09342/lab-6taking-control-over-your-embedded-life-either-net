/*
 * Damon Boorstein and Brendan Nugent
 * Lab 6: Open Loop Control
 *
 * Description: ADC12B is used to perform a temperature sample, sourced from P1.3, on Timer A interrupt and output to LCD.
 * TACCR0 interrupt occurs every 100ms and VRef is 1.2V, set by ADC12VRSEL_1.
 *
 * Original Code by Stephen Glass
*/
...
__interrupt void Timer0_A1 (void)
{
    if(pauseUpdate) // IF the button was pressed to pause updating
    {
        ...
        ADC_check = (ADC_Result*0.02929688);
        ADCdisplay = 4;
        while (ADC_check > 0)
        {
